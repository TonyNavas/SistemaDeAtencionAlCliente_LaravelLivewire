...
<link rel="stylesheet" href="{{ asset('layouts/collapsible-menu/css/light/loader.css') }}">
<link rel="stylesheet" href="{{ asset('layouts/collapsible-menu/css/dark/loader.css') }}">
